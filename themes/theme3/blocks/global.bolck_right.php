...
function nv4_block_bolck_right( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.bolck_right.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_bolck_right( $block_config );
}
